...
# 显式指定 tesseract 路径（解决 Windows 下找不到的问题）
try:
    pytesseract.pytesseract.tesseract_cmd = r'D:\develop\tessertact-QCR\tesseract.exe'  # Windows 示例路径
except Exception:
    pass  # 保持默认行为，若用户已配置 PATH 则无需修改
...
if __name__ == "__main__":
    csv_path = "mapper/course_knowledge_mapper48.csv"  # 上传的 CSV 文件路径
